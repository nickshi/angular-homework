...
export class AppComponent {
  ...
  search(searchText: HTMLInputElement) {
    if(typeof this.classList[searchText.value] !== 'undefined') {
      this.searchResult = this.classList[searchText.value];
    } else {
      this.searchResult = 'NO MATCH NAME. PLEASE TRY AGAIN';
    }
    
    console.log(this.classList[searchText.value]);
  }
